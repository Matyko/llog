                      ...
                      builder: (_, hasDarkMode) {
                        return MaterialApp(
                            theme: ThemeData(
                                ...
                                backgroundColor: hasDarkMode ? Colors.grey
                                    .shade800 : Colors.white,
                                scaffoldBackgroundColor: hasDarkMode ? Colors
                                    .grey.shade900 : Colors.grey.shade200,
                                cardColor: hasDarkMode
                                    ? Colors.grey.shade700
                                    : Colors.white,
                                fontFamily: 'Montserrat',
                                iconTheme: IconThemeData(
                                    color: hasDarkMode ? Colors.white : Colors
                                        .grey.shade800
                                ),
                                textTheme: TextTheme(
                                  bodyText1: TextStyle(
                                ...
                                bottomNavigationBarTheme: BottomNavigationBarThemeData(
                                  backgroundColor: hasDarkMode ? Colors.grey
                                      .shade800 : Colors.white,
                                  unselectedItemColor: hasDarkMode ? Colors
                                      .white : Colors.grey.shade800,
                                ),
                                appBarTheme: AppBarTheme(
                                    backgroundColor: hasDarkMode ? Colors.grey
                                        .shade900 : Colors.grey.shade200,
